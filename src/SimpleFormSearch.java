...
public class SimpleFormSearch extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            String selectSQL = "SELECT * FROM NolteProjectTable";
            preparedStatement = connection.prepareStatement(selectSQL);
         } else {
            String selectSQL = "SELECT * FROM NolteProjectTable WHERE EVENT LIKE ?";
         ...
         while (rs.next()) {
             ...
             if (keyword.isEmpty() || event.contains(keyword)) {
                out.println("Name: " + firstName + " " + lastName + ", ");
                out.println("Time: " + time + ", ");
                out.println("Date: " + date + ", ");
                out.println("Event: " + event + "<br>");
             }
          }
          out.println("<a href=/NolteTechProject/simpleFormSearch.html>Search Events</a> <br>");
