...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Chas\\OneDrive - University of Nebraska at Omaha\\Desktop\\workspaceCSCI4830-ex-0210-Nolte\\NolteTechProject\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/NolteTechProject/config.properties";
